...
* Submission:
    ...
    * Use the following file-naming convensation; fail to do so will receive 10% reduction in the grade:
        ...
        * For example, if you have three students in the group for Lab 1, and their names are Gerard Kelly, Steve Yang, and Jeffrey Yau, then you should name your file the following
            * GerardKelly_SteveYang_JeffreyYau_Lab1.Rmd
            * GerardKelly_SteveYang_JeffreyYau_Lab1.pdf
